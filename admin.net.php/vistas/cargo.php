...
if (isset($_POST['consulta'])) {
    ...
    $query = "select * from cargo where nombreCargo like
    '%$obj->nombreCargo%' ";
...
<body>
    <div id="main-container">
        <center>
            <h1>Cargos</h1>
            <form action="" name="cargo" method="POST">
                <table width="500">
                    <tr>
                        <td>
                            <a href="agregarCargo.php">
                        ...
                        <td>
                            <input class="place"type="text" name="nombreCargo" id="nombreCargo"
                                placeholder="Digite el nombre del Cargo" size="50">
                        </td>
                        <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                        echo "modificarCargo.php?key=".urlencode($arreglo[0]);
                                        }?>">
                            ...
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                            echo "eliminarCargo.php?key=".urlencode($arreglo[0]);
                                                }?>">
