...
if(isset($_POST['consulta'])){
        ...
        $query = "select * from documentos where nombreDocumento like'%$obj->nombreDocumento%'";
            ...
            <form action="" name="documentos" method="POST">
                <table width="500">
                    <tr>
                        ...
                        <td>
                            <input class="place" type="text" name="nombreDocumento" id="nombreDocumento"
                                placeholder="Digite el nombre del Documento" size="50">
                        </td>
                        <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                    echo "modificarDocumento.php?key=".urlencode($arreglo[0]);
                                }?>">
                            ...
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                    echo "eliminarDocumento.php?key=".urlencode($arreglo[0]);
                                }?>">
