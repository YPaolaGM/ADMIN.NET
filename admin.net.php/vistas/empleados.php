...
if(isset($_POST['consulta'])){
   // echo "<script>alert('llegue')</script>";
        ...
        $query = "select * from empleados where numeroDocumento like
        '%$obj->numeroDocumento%'";
            ...
            <form action="" name="clientes" method="POST">
                <table width="500">
                    <tr>
                        ...
                        <td>
                            <input class="place" type="text" name="numeroDocumento" id="numeroDocumento"
                                placeholder="Digite el Numero del Documento del Empleado" size="50">
                        </td>
                        <td>
                ...
                <table class="listar" border="1" width="1000">
                    <thead>
                        <tr>
                            ...
                            <td>
                                <center>Tipo de Documento</center></b>
                            </td>
                            <td>
                            <b> <center>Tipo de Cargo</center></b>
                            </td>
                            <td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                $clas = new Conexion();
                                $conecta = $clas->conectando();
                                $query2 = "SELECT nombreCargo from cargo where idCargo ='$arreglo[2]'";
                                $res1=mysqli_query($conecta,$query2);
                            ...
                            <td><?php 
                                $clas = new Conexion();
                                $conecta = $clas->conectando();
                                $query3 = "SELECT Ubicacion  from asignacionempleados where idAsignacionEmpleados ='$arreglo[7]'";
                                $res2=mysqli_query($conecta,$query3);
                                $a=mysqli_fetch_array($res2);
                                echo $a[0];
                                                                ?></td>
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                    echo "modificarEmpleados.php?key=".urlencode($arreglo[0]);
                                }?>">
                            ...
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                    echo "eliminarEmpleados.php?key=".urlencode($arreglo[0]);
                                }?>">
