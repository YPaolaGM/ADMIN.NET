...
if(isset($_POST['consulta'])){
        ...
        $query = "select * from servicios where codigoServicio like
        '%$obj->codigoServicio %' ";
...
<body>
    <div id="main-container">
        <center>
            <h1>Contrato</h1>
            <form action="" name="servicios" method="POST">
                <table width="500">
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="place" type="text" name="codigoServicio " id="codigoServicio "
                ...
                <table class="listar" border="1" width="1000">
                    <thead>
                        <tr>
                            ...
                            <td>
                                <center>Aseo y Seguridad</center>
                            </td>
                            <td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                $clas = new Conexion();
                                $conecta = $clas->conectando();
                                $query1 = "SELECT numeroContrato from contratoservicio where codigoContrato ='$arreglo[1]'";
                            ...
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                    echo "modificarServicios.php?key=".urlencode($arreglo[0]);
                                }?>">
                            ...
                            <td>
                                <a href="<?php if($arreglo[0]<>""){
                                    echo "eliminarServicios.php?key=".urlencode($arreglo[0]);
                                }?>">
